...
- respecting the project's safety, source-authorization, privacy, and responsible-operation boundaries.
...
- pressuring contributors to bypass source policies, authorization interlocks, security controls, or responsible disclosure;
- other conduct that could reasonably be considered inappropriate in a professional setting.

## Scope

This Code of Conduct applies in all project spaces, including issues, pull requests, reviews, community interactions, and project-related private communication. It also applies when an individual officially represents the project in public spaces.
...
Maintainers will use these Community Impact Guidelines when determining consequences.
...
**Consequence:** A warning with consequences for continued behavior. The individual may have no interaction with the people involved, including unsolicited contact with those enforcing the Code of Conduct, for a specified period. Violating these terms may lead to a temporary or permanent ban.

### 3. Temporary ban

**Community impact:** A serious violation of community standards, including sustained inappropriate behavior.

**Consequence:** A temporary ban from interaction or public communication with the community for a specified period. Violating the ban may lead to a permanent ban.

### 4. Permanent ban

**Community impact:** A pattern of violating community standards, harassment of an individual, aggression toward or disparagement of classes of individuals, or another severe violation.

**Consequence:** Permanent removal from project community interaction.
